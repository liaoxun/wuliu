									...
									<TD>
									    <table width="99%" border="0" cellpadding="9" cellspacing="9" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
											  ...
											  <tr align='center' bgcolor="#FFFFFF" height="22">
													...
													<td bgcolor="#FFFFFF" align="left">
														 <a href="<%=path %>/goods?type=goodsDetailQian&id=${goods.id}">详细信息</a>
													</td>
											  </tr>
											  </c:forEach>
					        		     </table>
									...
									<TD>
									    <table width="99%" border="0" cellpadding="9" cellspacing="9" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
											...
											<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
												...
												<td bgcolor="#FFFFFF" align="left">
													 <a href="<%=path %>/gongsi?type=gongsiDetailQian&id=${gongsi.id}">详细信息</a>
												</td>
											</tr>
											</c:forEach>
										</table>
